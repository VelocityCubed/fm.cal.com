      ...
      <Html
        ...
        <Head nonce={nonce}>
          ...
          <link
            ...
            sizes="180x180"
            href="https://fertilitymapperprod.blob.core.windows.net/assets/icons/apple-touch-icon.png"
          />
          <link
            rel="icon"
            type="image/png"
            sizes="32x32"
            href="https://fertilitymapperprod.blob.core.windows.net/assets/icons/favicon-32x32.png"
          />
          <link
            rel="icon"
            type="image/png"
            sizes="16x16"
            href="https://fertilitymapperprod.blob.core.windows.net/assets/icons/favicon-16x16.png"
          />
